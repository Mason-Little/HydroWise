...
export const makeQueries = (db: Db) => {
  ...
  return {
    ...
    listPagesByCourse: pages.listPagesByCourse,
    listPagesByChapter: pages.listPagesByChapter,
    listPagesByTopic: pages.listPagesByTopic,
    listPagesByDocument: pages.listPagesByDocument,
