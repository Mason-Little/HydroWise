...
CREATE TABLE "courses" (
	...
	"textbook" text DEFAULT '' NOT NULL,
	"schedule" text DEFAULT '' NOT NULL,
	"grade_rubric" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"grade_scale" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"test_dates" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
CREATE TABLE "pages" (
	...
	"page_abstract" text NOT NULL,
	"page_content" text NOT NULL,
	"page_image" "bytea",
	"page_embedding" vector(768) NOT NULL
);
--> statement-breakpoint
CREATE TABLE "topics" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE INDEX "pages_embedding_cosine_idx" ON "pages" USING hnsw ("page_embedding" vector_cosine_ops);