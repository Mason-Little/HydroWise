  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div
          className={cn(
            "flex size-7 shrink-0 items-center justify-center rounded-[10px] border bg-background shadow-[inset_0_1px_0_rgba(255,255,255,0.65)]",
            selected
        ...
        >
          <Icon className="size-[13px]" aria-hidden strokeWidth={1.9} />
        </div>
        <div
          className={cn(
      ...
      <div className="mt-2 min-w-0">
        <div
          className={cn(
            "text-[0.86rem] font-bold capitalize tracking-[-0.02em]",
            selected
        ...
        <div className="mt-0.5 max-w-[22ch] text-[0.75rem] font-semibold leading-[1.35] text-[var(--app-text-muted)]">
          {scope.description}
        </div>
      </div>
    </button>
